namespace EcChocolateAsp.Models
{
    public class Review
    {
        public Review(string userName, string title, string body, int score)
        {
            UserName = userName;
            Title = title;
            Body = body;
        ...
        public Review(int id, string userName, string title, string body, int score)
            : this(userName, title, body, score)
        {
            Id = id;
        }
