...
namespace EcChocolateAsp.Areas.Admin.Controllers
{
    ...
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Phone,Guest,ArrangementPrice,Date")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Phone,Guest,ArrangementPrice,Date")] Reservation reservation)
        {
